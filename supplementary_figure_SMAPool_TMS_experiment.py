...
#synaptic_weight=0.00037 #this number is set to an EPSP is 212 muV
synaptic_weight=0.00037/2 #this number is set to an EPSP is 212 muV


Name_file_record="Reduced_synaptic_CST_TMS_experiment_SMA"+str(num_SMA_MN)+"WT"+str(num_WT_MN)+"_MNs_supraspinal"+str(num_supraspinal)+"fr_"+str(rate_supraspinal)+"_SCSfreq"+str(rate_scs)+"_SCS_num"+str(num_scs)+".pickle"
